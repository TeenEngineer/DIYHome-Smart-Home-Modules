...
byte rotation = 0;   // 0, 1, 2, 3  → (0°,90°,180°,270°)
...
void customModes() {
  switch (thisMode) {
    ...
    case 0: fillString(runningText, globalColor);
      break;
    /*case 1: fillString("1234567890!@#$%^&*(){}ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz:;\"'{[}]\|/-_=+", 1);
      break;
    ...
    case 0: snakeRoutine();
      break;
    case 1: tetrisRoutine();
      break;
    case 2: mazeRoutine();
      break;
    case 3: runnerRoutine();
      break;
    case 4: flappyRoutine();
      break;
    case 5: arkanoidRoutine();
      break;
    //case 6: clockRoutine();
      //break;*/
